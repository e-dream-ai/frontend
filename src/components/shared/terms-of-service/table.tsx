  ...
  <StyledTable>
    ...
    <tbody>
      <tr>
        ...
        <td>
          Included - the company may distribute your content to other users and
          transform it for interactive display
        </td>
      ...
      <tr>
        ...
        <td>
          Permitted - others may modify, reshare, and remix, as long as they
          credit you
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          Same as basic but cannot retroactively revoke rights for pre-existing
          downloads/derivatives
        </td>
      </tr>
    </tbody>
  </StyledTable>
