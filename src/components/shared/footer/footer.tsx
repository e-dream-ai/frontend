    ...
    <>
      ...
      >
        <span className="fa-stack fa-lg">
          ...
          <i className="fa fa-facebook fa-stack-1x fa-inverse reverse"></i>
        </span>
      </Anchor>
      <Anchor href="https://twitter.com/electricshe3p" target="_blank">
        <span className="fa-stack fa-lg">
          <i className="fa fa-circle fa-stack-2x"></i>
          <i className="fa fa-twitter fa-stack-1x fa-inverse reverse"></i>
        </span>
      </Anchor>
      <Anchor
      ...
      >
        <span className="fa-stack fa-lg">
          <i className="fa fa-circle fa-stack-2x"></i>
          <i className="fa fa-github fa-stack-1x fa-inverse reverse"></i>
        </span>
      </Anchor>
    </>
  );
